          ...
          <section className=" grid md:grid-cols-3 md:gap-4 lg:gap-12 justify-items-center desktop:gap-24">
            ...
            <div className="mb-10 ">
              ...
              <div className="mx-auto grid grid-cols-5 gap-x-3 mt-6 text-red-800">
                ...
                <Link href="https://mobile.twitter.com/sdamissionug">
                  <p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
                ...
                <Link href="https://www.pinterest.com/search/my_pins/?q=sdamissionug&rs=filter">
                  <p className="footer-link">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                ...
                <Link href="https://www.instagram.com/sdamissionugfullgospelweb/">
                  <p className="footer-link">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="21"
