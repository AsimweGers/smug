...
const About = () => {
  const SEO = {
    title: "About Us | SMUG",
    description:
      "SMUG is a gospel based music website that gives you all the gospel music and much more across the world",
    additionalMetaTags: [
      {
        property: "keywords",
        name: "keywords",
        content:
          "SMUG, sda mission , SMUG music, sda, kblc, kasese better living center, light fm kasese, awr light fm, Kasese News Updates, Kasese Technology, Loans in Kasese, Insurance in Kasese, Make Money Kasese, Kasese Entertainment, Free Data Kasese,how to see my ubteb results online, how to see my uneb results online,how to see my unmeb results online, Services at Free Costs in Kasese, Rwenzori tv live Rwenzori tv live streaming,",
      },
    ],
    additionalLinkTags: [
      {
      ...
      <div className="transition duration-500 ease transform hover:-translate-y-1 px-2 mt-4 items-center flex flex-col">
        ...
        <div className=" transition duration-500 ease transform hover:-translate-y-1  inline-block">
          <p className="text-xl p-2">
            SMUG is fully equipped gospel based website with the all kinds of
          ...
          <p className=" p-2 text-xl  mb-4">
            SMUG is the number one free gospel streaming and downloading
            website in uganda with the latest and free gospel music and much
            more. SMUG finds its strength in proclaiming the word of God
            through music and streaming gospel music and sermons through the
            SMUG Gospello Online radio for all users across the globe.
          </p>
          <p className="text-xl p-2">
            SMUG was created by{" "}
            <a
