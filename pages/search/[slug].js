...
const SearchPost = ({ posts }) => {
  ...
  const SEO = {
    title: "Search sdamissionug | The Home of Gospel | Resources | Events",
    description:
    ...
    additionalMetaTags: [
      {
        ...
        name: "keywords",
        content:
          "All you need finds you here, Search for sda songs, nonstops, sunday, praise and worship, hymns and more, sdamissionug, smug, sda, kblc, kasese better living center, light fm kasese, awr light fm, Kasese News Updates, Kasese Technology, Loans in Kasese, Insurance in Kasese, Make Money Kasese, Kasese Entertainment, Free Data Kasese,how to see my ubteb results online, how to see my uneb results online,how to see my unmeb results online, Services at Free Costs in Kasese, Rwenzori tv live Rwenzori tv live streaming,",
      },
    ],
    additionalLinkTags: [
      {
    ...
    openGraph: {
      type: "website",
      url: "https://sdamissionug.com/search",
      title: "Search sdamissionug | The Home of Gospel | Resources | Events",
      description:
        "All you need finds you here, Search for sda songs, nonstops, sunday, praise and worship, hymns and more",
      images: [
          ...
          <div className="col-span-1 flex flex-wrap lg:col-span-8">
            <div className="mt-5">
              <div className=" mb-1  flex text-center justify-center transition duration-500 ease transform hover:-translate-y-1 flex-col px-10 items-center lg:items-center bg-blue-600  rounded-full text-white py-3 cursor-pointer">
                <h1 className="font-large text-xl ">
                  Search sdamissionug Here
                </h1>
