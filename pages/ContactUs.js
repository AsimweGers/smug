...
const ContactUs = (props) => {
  ...
  const SEO = {
    title: "Contact Us for any Help | SMUG",
    description:
      "Contact Us | SMUG, contact Us for any help, We are readily available 24 / 7",
    additionalMetaTags: [
      {
        property: "keywords",
        name: "keywords",
        content:
          "SMUG, sda mission, sda, kblc, kasese better living center, light fm kasese, awr light fm, Kasese News Updates, Kasese Technology, Loans in Kasese, Insurance in Kasese, Make Money Kasese, Kasese Entertainment, Free Data Kasese,how to see my ubteb results online, how to see my uneb results online,how to see my unmeb results online, Services at Free Costs in Kasese, Rwenzori tv live Rwenzori tv live streaming,",
      },
    ],
    additionalLinkTags: [
      {
    ...
    openGraph: {
      type: "website",
      url: "https://sdamissionug.com/ContactUs",
      title: "Contact Us for any Help | SMUG",
      description:
        "Contact Us | SMUG, contact Us for any help, We are readily available 24 / 7",
      images: [
