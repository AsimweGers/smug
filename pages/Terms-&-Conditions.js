...
const Terms = () => {
  const SEO = {
    title: "Terms and Conditions | smug",
    description:
      "Welcome to smug company. These Terms of Service govern your use of our website located at smug.com together “Service” operated by smug.",
    additionalMetaTags: [
      {
        property: "keywords",
        name: "keywords",
    ...
    openGraph: {
      type: "website",
      url: "https://sdamissionug.com/Terms-&-Conditions",
      title: "Terms and Conditions | smug",
      description:
        "Welcome to smug company. These Terms of Service govern your use of our website located at sdamissionug.com together “Service” operated by smug.",
      images: [
        {
  ...
  return (
    <>
      ...
      <div className="transition duration-500 ease transform hover:-translate-y-1 inline-block items-center lg:items-center px-6 py-3">
        ...
        <p className="my-3">
          Welcome to <b>sdamissionug</b> Company!
        </p>
        <p className="my-3">
          ...
          <b>
            <a
              href="https://www.sdamissionug.com"
              className="hover:text-red-700"
            >
              sdamissionug.com
            </a>
          </b>{" "}
          together “Service” operated by <b>smug</b>.
        </p>
        <p className="my-3">
        ...
        <p className="my-3">
          smug has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p className="my-3">
          In addition, Content found on or through this Service are the property
          of smug or used with permission. You may not distribute, modify,
        ...
        <p className="my-3">
          ...
          property of smug and its licensors. Service is protected by copyright,
        ...
        <p className="my-3">
          ...
          that are not owned or controlled by smug.
        </p>
        <p className="my-3">
          smug has no control over, and assumes no responsibility for the
